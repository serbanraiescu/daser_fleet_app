...
$router->add('GET', '/admin/tenants/anaf-fetch', 'SuperAdminController@ajaxFetchAnafData', [\FleetLog\App\Middleware\AuthMiddleware::class, \FleetLog\App\Middleware\SuperAdminMiddleware::class]);
...
$router->add('GET', '/admin/tenants/test-report/{id}', 'SuperAdminController@testAdminReport', [\FleetLog\App\Middleware\AuthMiddleware::class, \FleetLog\App\Middleware\SuperAdminMiddleware::class]);
...
$router->add('GET', '/admin/media/download', 'SuperAdminController@downloadMediaArchive', [\FleetLog\App\Middleware\AuthMiddleware::class, \FleetLog\App\Middleware\SuperAdminMiddleware::class]);
$router->add('GET', '/admin/media/delete', 'SuperAdminController@deleteOldMedia', [\FleetLog\App\Middleware\AuthMiddleware::class, \FleetLog\App\Middleware\SuperAdminMiddleware::class]);
...
$router->add('POST', '/admin/sms/mass-send', 'SuperAdminController@sendMassSms', [\FleetLog\App\Middleware\AuthMiddleware::class, \FleetLog\App\Middleware\SuperAdminMiddleware::class]);
...
$router->add('GET', '/tenant/vehicles/qr-print', 'TenantController@qrPrint', [\FleetLog\App\Middleware\AuthMiddleware::class, \FleetLog\App\Middleware\TenantStatusMiddleware::class]);
...
$router->add('GET', '/tenant/drivers/restore/{id}', 'TenantController@restoreDriver', [\FleetLog\App\Middleware\AuthMiddleware::class, \FleetLog\App\Middleware\TenantStatusMiddleware::class]);
...
$router->add('GET', '/tenant/fuelings/receipts', 'TenantController@fuelingReceipts', [\FleetLog\App\Middleware\AuthMiddleware::class, \FleetLog\App\Middleware\TenantStatusMiddleware::class]);
...
$router->add('POST', '/tenant/vehicle-events/edit', 'VehicleEventController@update', [\FleetLog\App\Middleware\AuthMiddleware::class, \FleetLog\App\Middleware\TenantStatusMiddleware::class]);
$router->add('POST', '/tenant/vehicle-events/delete', 'VehicleEventController@destroy', [\FleetLog\App\Middleware\AuthMiddleware::class, \FleetLog\App\Middleware\TenantStatusMiddleware::class]);
...
$router->add('GET', '/tenant/reports/driver/{id}', 'ReportController@driverDetails', [\FleetLog\App\Middleware\AuthMiddleware::class, \FleetLog\App\Middleware\TenantStatusMiddleware::class]);
