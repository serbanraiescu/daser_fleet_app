...
$router->add('GET', '/tenant/reports/trips/export', 'ReportController@exportTrips', [\FleetLog\App\Middleware\AuthMiddleware::class, \FleetLog\App\Middleware\TenantStatusMiddleware::class]);
