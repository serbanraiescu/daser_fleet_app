<div class="p-4 max-w-md mx-auto">
    <div class="bg-white rounded-2xl shadow-xl border border-slate-200 overflow-hidden">
        <div class="bg-blue-600 p-6 text-white text-center">
            ...
            <h1 class="text-2xl font-bold">Completează Profilul</h1>
            <p class="text-blue-100 mt-2">Pentru a continua, avem nevoie de câteva date obligatorii.</p>
        </div>
        ...
        <form action="/driver/complete-profile" method="POST" class="p-6 space-y-5">
            ...
            <div>
                <label class="block text-sm font-bold text-slate-700 mb-2 uppercase tracking-wide">CNP</label>
            ...
            <div>
                <label class="block text-sm font-bold text-slate-700 mb-2 uppercase tracking-wide">Data Expirare Buletin (CI)</label>
            ...
            <div>
                <label class="block text-sm font-bold text-slate-700 mb-2 uppercase tracking-wide">Data Expirare Permis</label>
    ...
    <div class="mt-6 text-center text-slate-500 text-sm">
        <p>Ai nevoie de ajutor? Contactează administratorul flotei.</p>
        <a href="/logout" class="text-blue-600 font-bold mt-2 block">Ieșire din cont</a>
    </div>
</div>
