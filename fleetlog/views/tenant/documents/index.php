<div class="max-w-7xl mx-auto">
    ...
    <div class="mb-8 border-b border-slate-200">
        <nav class="flex space-x-8">
            <a href="#" class="border-b-2 border-indigo-500 py-4 px-1 text-sm font-black text-indigo-600">
                <?php echo __('handover_protocol'); ?>
            </a>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-slate-200">
                <thead class="bg-slate-50">
                    <tr>
                        <th class="px-6 py-4 text-left text-xs font-black text-slate-500 uppercase tracking-widest"><?php echo __('document_number'); ?></th>
                        ...
                        <?php foreach ($reports as $report): ?>
                            <tr class="hover:bg-slate-50 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <a href="/tenant/documents/handover/view/<?php echo $report['id']; ?>" target="_blank" class="inline-flex items-center text-indigo-600 hover:text-indigo-900 bg-indigo-50 px-3 py-1.5 rounded-lg transition-colors">
