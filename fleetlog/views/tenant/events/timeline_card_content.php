<div class="flex justify-between items-start mb-2">
    <div>
        <!-- Desktop Badge -->
        <span class="hidden md:inline-block <?php echo $styleClass; ?> border px-2 py-0.5 rounded-md text-[10px] font-bold uppercase tracking-wider mb-2"><?php echo $event['event_type']; ?></span>
