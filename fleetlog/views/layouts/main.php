        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" class="fixed inset-y-0 left-0 z-50 w-72 bg-slate-900 text-white transition-transform duration-300 transform lg:translate-x-0 lg:static lg:inset-0 flex flex-col shadow-2xl lg:shadow-none">
            ...
            <nav class="mt-4 px-4 space-y-1 flex-1 flex flex-col overflow-y-auto">
                <?php if (\FleetLog\Core\RBAC::isSuperAdmin() && !\FleetLog\Core\Auth::isImpersonating()): ?>
                    ...
                    <a href="/admin/status" class="flex items-center px-4 py-2 hover:bg-slate-800 rounded-lg group">
                        <svg class="w-5 h-5 mr-3 text-slate-400 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                        System Status
                    </a>
                    ...
                    <a href="/admin/sms-logs" class="flex items-center px-4 py-2 hover:bg-slate-800 rounded-lg group">
                ...
                <?php if ($showTenantLinks): ?>
                    ...
                    <a href="/tenant/documents" class="flex items-center px-4 py-2 hover:bg-slate-800 rounded-lg group">
                        <svg class="w-5 h-5 mr-3 text-slate-400 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
            ...
            <div class="mt-auto pt-6 pb-6 border-t border-slate-800/50 px-4">
                <div class="flex flex-col items-center">
                    ...
                    <div class="text-[10px] text-slate-500 text-center space-y-1">
                        <p class="font-bold text-slate-600 mb-1">DASER FLEET v1.6.0</p>
